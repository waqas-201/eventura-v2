        ...
        <section className="bg-black py-12 md:py-20  ">
            <div className=" mx-auto">
                <div className="grid grid-cols-1  w-full md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="bg-primary rounded-lg aspect-[16/9] flex flex-col justify-center items-center p-8 text-center hover:bg-primary/80 transition-colors duration-300 cursor-pointer">
                        <div className="space-y-6">
                            ...
                            <Button
                                variant="outline"
                                className="bg-transparent border-2 border-black text-black hover:bg-black hover:text-primary font-semibold px-8 py-2 rounded-full transition-all duration-300"
                            >
                                EXPLORE
                            </Button>
                        </div>
